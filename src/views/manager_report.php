<main class="content">
    <?php
        renderTitle(
            'Relatório Gerencial',
            'Resumo de Horas Trabalhadas dos Funcionários',
    ...
    <?php if (count($activeUsersCount) > 0):?>
        <div class="card mt-4">
            <div class="card-header">
                <h4 class="card-title">Faltosos do Dia<br></h4>
                <p class="card-category mb-0">Relação dos funcionários que ainda não bateram o cartão</p>
            </div>
            <div class="card-body">
